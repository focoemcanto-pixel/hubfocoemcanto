...
const rules: WatchRule[] = [
  { path: '/aluno/perfil-vocal', successText: 'Mapa Vocal salvo no seu perfil.', nextStep: 'profile', title: 'Mapa Vocal salvo', description: 'Sua voz já foi configurada. Agora vamos completar seu perfil para personalizar sua experiência.' },
  { path: '/aluno/perfil/editar', successText: 'Perfil salvo. As alterações já foram aplicadas.', nextStep: 'tour', title: 'Perfil concluído', description: 'Muito bom. Agora o guia continua com uma apresentação rápida das abas principais do Hub.' },
];
