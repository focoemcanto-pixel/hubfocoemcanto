...
import { DailyEarTrainingFlowV8 } from '@/components/daily-ear-training-flow-v8';
...
export function AdaptiveDailyTrainingPlayer({ step, exercise, total }: { step: DailyTrainingStep; exercise: TrainingExercise; total: number }) {
  ...
  if (exercise.categorySlug === 'percepcao') return <DailyEarTrainingFlowV8 step={step} exercise={personalizedExercise} />;
