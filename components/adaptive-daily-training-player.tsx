...
import { DailyEarTrainingFlowV9 } from '@/components/daily-ear-training-flow-v9';
...
export function AdaptiveDailyTrainingPlayer({ step, exercise, total }: { step: DailyTrainingStep; exercise: TrainingExercise; total: number }) {
  ...
  if (exercise.categorySlug === 'percepcao') return <DailyEarTrainingFlowV9 step={step} exercise={personalizedExercise} />;
