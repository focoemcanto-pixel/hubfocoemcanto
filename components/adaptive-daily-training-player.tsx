...
import { DailyEarTrainingFlowV11 } from '@/components/daily-ear-training-flow-v11';
...
export function AdaptiveDailyTrainingPlayer({ step, exercise, total }: { step: DailyTrainingStep; exercise: TrainingExercise; total: number }) {
  ...
  if (exercise.categorySlug === 'percepcao') return <DailyEarTrainingFlowV11 step={step} exercise={personalizedExercise} />;
