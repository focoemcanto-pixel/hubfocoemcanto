...
import { DailyEarTrainingFlowV5 } from '@/components/daily-ear-training-flow-v5';
...
export function AdaptiveDailyTrainingPlayer({ step, exercise, total }: { step: DailyTrainingStep; exercise: TrainingExercise; total: number }) {
  ...
  if (exercise.categorySlug === 'percepcao') return <DailyEarTrainingFlowV5 step={step} exercise={personalizedExercise} />;
