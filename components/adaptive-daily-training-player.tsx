...
import { DailyEarTrainingFlowV10 } from '@/components/daily-ear-training-flow-v10';
...
export function AdaptiveDailyTrainingPlayer({ step, exercise, total }: { step: DailyTrainingStep; exercise: TrainingExercise; total: number }) {
  ...
  if (exercise.categorySlug === 'percepcao') return <DailyEarTrainingFlowV10 step={step} exercise={personalizedExercise} />;
