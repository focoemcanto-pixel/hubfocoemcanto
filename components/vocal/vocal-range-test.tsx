    ...
    {step === 'lowest' && <section className="vocal-stage grid range-capture">
      ...
      <div className="range-copy">
        <div className="capture-top-card">
          <p className="eyebrow">ETAPA 1/3</p>
          <h1>Mapeie sua extensão vocal</h1>
          <p className="range-helper">Cante do grave ao agudo. A régua marca os extremos.</p>
        </div>
