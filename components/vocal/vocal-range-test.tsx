...
function MobileRangeCapture({ currentMidi, liveNote, captureReady, captureReview, captureRange, onBack, onRetry, onPrimary }: any) {
  ...
  return <div className="mvr-shell">
    ...
    <div className="mvr-visual"><div className="mvr-aura" /><img src="/vocal/vocal-body-base.png" alt="Silhueta vocal" draggable={false} /><b className="mvr-glow" /><span className="head">CABEÇA</span><span className="mix">VOZ MISTA</span><span className="chest">PEITO</span></div>
...
@media(max-width:760px){.vocal-test-shell{padding:0;background:#020304;min-height:100dvh;overflow:hidden}.range-capture{position:fixed!important;inset:0!important;width:100vw!important;height:100dvh!important;max-width:none!important;margin:0!important;padding:0!important;border:0!important;border-radius:0!important;background:#020304!important;box-shadow:none!important;overflow:hidden!important;z-index:2147483647!important}.range-desktop-ui{display:none!important}.mvr-shell{display:block;position:absolute;inset:0;background:radial-gradient(circle at 62% 48%,rgba(55,210,224,.16),transparent 30%),radial-gradient(circle at 62% 61%,rgba(245,199,107,.14),transparent 28%),#020304;color:#fff;overflow:hidden}.mvr-ruler{position:absolute;left:28px;top:calc(178px + env(safe-area-inset-top));width:112px;height:calc(100dvh - 332px);z-index:20}.mvr-line{position:absolute;left:72px;top:0;bottom:0;width:3px;background:linear-gradient(180deg,#67e8f9 0%,#67e8f9 53%,#f5c76b 53%,#f5c76b 100%);box-shadow:0 0 18px rgba(103,232,249,.5)}.mvr-ruler:after{content:'';position:absolute;left:72px;top:0;bottom:0;width:32px;background:repeating-linear-gradient(to bottom,rgba(255,255,255,.25) 0 1px,transparent 1px 31px)}.mvr-ruler span{position:absolute;left:0;transform:translateY(-50%);font-size:12px;line-height:1;font-weight:850;color:rgba(255,255,255,.56);white-space:nowrap}.mvr-ruler span.octave{font-size:20px;font-weight:1000;color:rgba(255,255,255,.96)}.mvr-dot{position:absolute;left:48px;width:50px;height:50px;border-radius:999px;background:#67e8f9;transform:translateY(-50%);box-shadow:0 0 28px rgba(103,232,249,.9),0 0 70px rgba(103,232,249,.5);z-index:10}.mvr-visual{position:absolute;left:126px;right:-36px;top:calc(184px + env(safe-area-inset-top));height:calc(100dvh - 382px);z-index:4}.mvr-visual:before{content:'';position:absolute;inset:0;background:rgba(5,7,10,.38)}.mvr-aura{position:absolute;inset:14% 0 14% 0;border-radius:999px;background:radial-gradient(ellipse at center,rgba(103,232,249,.16),rgba(103,232,249,.04) 45%,transparent 72%);filter:blur(20px)}.mvr-visual img{position:absolute;right:-8vw;top:8%;width:96vw;height:86%;object-fit:contain;object-position:center top;opacity:.74;mix-blend-mode:screen;filter:drop-shadow(0 0 24px rgba(236,254,255,.16))}.mvr-glow{position:absolute;left:50%;top:52%;width:26%;height:16%;border-radius:999px;background:radial-gradient(ellipse at center,rgba(255,235,170,.95),rgba(245,199,107,.48) 38%,transparent 72%);filter:blur(10px) drop-shadow(0 0 30px rgba(245,199,107,.85));transform:translate(-50%,-50%)}.mvr-visual span{position:absolute;right:7vw;font-size:14px;font-weight:950;letter-spacing:.05em;color:rgba(255,255,255,.62);text-transform:uppercase}.mvr-visual .head{top:10%}.mvr-visual .mix{top:28%}.mvr-visual .chest{top:47%;color:#f5c76b;text-shadow:0 0 18px rgba(245,199,107,.8)}.mvr-shell header{position:absolute;top:calc(92px + env(safe-area-inset-top));left:142px;right:18px;text-align:center;z-index:30}.mvr-shell header small{display:block;margin-bottom:12px;color:rgba(255,255,255,.5)!important;font-size:12px;font-weight:1000;letter-spacing:.16em}.mvr-shell header h1{margin:0;color:#fff;font-size:clamp(25px,7vw,33px);line-height:1.04;letter-spacing:-.045em;font-weight:1000;text-shadow:0 0 16px rgba(0,0,0,.9)}.mvr-shell header p{margin:12px auto 0;color:rgba(255,255,255,.62);font-size:15px;line-height:1.22;max-width:420px;text-shadow:0 0 12px rgba(0,0,0,.9)}.mvr-note{position:absolute;left:50%;bottom:calc(154px + env(safe-area-inset-bottom));transform:translateX(-2%);z-index:35;padding:10px 18px;border:1px solid rgba(255,255,255,.15);border-radius:18px;background:rgba(0,0,0,.54);text-align:center;backdrop-filter:blur(14px)}.mvr-note small{display:block;color:rgba(255,255,255,.58)!important;font-size:11px!important;font-weight:900;letter-spacing:.13em}.mvr-note strong{display:block;color:#67e8f9;font-size:36px;line-height:.95;letter-spacing:-.05em}.mvr-result{position:absolute;left:144px;right:18px;bottom:calc(222px + env(safe-area-inset-bottom));z-index:40;padding:10px 14px;border-radius:18px;border:1px solid rgba(255,255,255,.12);background:rgba(0,0,0,.55);text-align:center}.mvr-result span{display:block;font-size:10px;text-transform:uppercase;letter-spacing:.13em;color:rgba(255,255,255,.55)}.mvr-result strong{display:block;color:#67e8f9;font-size:24px}.mvr-back,.mvr-retry{position:absolute;bottom:calc(62px + env(safe-area-inset-bottom));z-index:60;width:70px!important;height:70px!important;min-height:70px!important;border-radius:999px!important;background:rgba(255,255,255,.055)!important;border:1px solid rgba(255,255,255,.16)!important;color:#fff!important;padding:0!important;font-size:32px!important;backdrop-filter:blur(14px)}.mvr-back{left:34px}.mvr-retry{right:34px}.mvr-retry svg{width:30px;height:30px}.mvr-main{position:absolute;left:50%;bottom:calc(68px + env(safe-area-inset-bottom));transform:translateX(-50%);z-index:65;width:min(52vw,420px)!important;min-width:210px!important;height:58px!important;min-height:58px!important;border-radius:999px!important;background:linear-gradient(180deg,#ffe29a,#e8ad34)!important;color:#120d05!important;font-size:17px!important;font-weight:1000!important;white-space:nowrap!important;padding:0 22px!important}.vocal-stage:not(.range-capture),.vocal-stage.tessitura-grid{margin:18px 14px;border-radius:24px;padding:18px}.vocal-stage.tessitura-grid{grid-template-columns:1fr}.tessitura-copy{order:2}.tessitura-grid>.vocal-meter{order:1}.choice-grid,.result-grid{grid-template-columns:1fr}}
`;
