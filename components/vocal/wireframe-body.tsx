...
function bodyTopFromMidi(midi?: number | null) {
  ...
  if (clamped <= 55) return 47 - ((clamped - 40) / 15) * 2;
  if (clamped <= 71) return 34 - ((clamped - 55) / 16) * 10;
  return 18 - ((clamped - 72) / 12) * 2;
}
