...
function bodyTopFromMidi(midi?: number | null) {
  ...
  if (clamped <= 55) return 48 - ((clamped - 40) / 15) * 2;
  if (clamped <= 71) return 39 - ((clamped - 55) / 16) * 15;
  return 23 - ((clamped - 72) / 12) * 6;
}
...
const bodyCss = `.wireframe-body-wrap{position:relative;min-height:100%;border-radius:24px;background:radial-gradient(circle at 50% 30%,rgba(103,232,249,.12),transparent 35%),radial-gradient(circle at 50% 70%,rgba(245,199,107,.08),transparent 38%),rgba(255,255,255,.025);overflow:hidden;display:grid;place-items:center;padding:4px}.body-aura{position:absolute;inset:5% 10%;border-radius:999px;background:radial-gradient(ellipse at center,rgba(103,232,249,.12),rgba(103,232,249,.03) 42%,transparent 70%);filter:blur(10px)}.vocal-body-base{position:relative;z-index:2;width:min(100%,380px);height:min(96%,620px);object-fit:contain;object-position:center;opacity:.95;filter:drop-shadow(0 0 18px rgba(236,254,255,.18)) drop-shadow(0 0 48px rgba(103,232,249,.10));user-select:none;pointer-events:none}.body-glow-zone,.body-live-glow{position:absolute;left:50%;transform:translateX(-50%);z-index:3;opacity:0;transition:opacity .32s ease,transform .32s ease,top .22s ease,width .22s ease,height .22s ease;mix-blend-mode:screen;pointer-events:none}.body-glow-zone.is-active{opacity:.42;transform:translateX(-50%) scale(1.02)}.body-glow-zone.head{top:15%;width:21%;height:13%;border-radius:999px;background:radial-gradient(ellipse at center,rgba(167,139,250,.92),rgba(124,58,237,.34) 38%,transparent 70%);filter:blur(7px) drop-shadow(0 0 22px rgba(167,139,250,.88))}.body-glow-zone.mix{top:27%;width:29%;height:21%;border-radius:999px;background:radial-gradient(ellipse at center,rgba(103,232,249,.86),rgba(103,232,249,.32) 48%,transparent 74%);filter:blur(8px) drop-shadow(0 0 22px rgba(103,232,249,.72))}.body-glow-zone.chest{top:43%;width:34%;height:18%;border-radius:999px;background:radial-gradient(ellipse at center,rgba(245,199,107,.86),rgba(245,199,107,.34) 48%,transparent 74%);filter:blur(8px) drop-shadow(0 0 22px rgba(245,199,107,.76))}.body-live-glow{border-radius:999px;background:radial-gradient(ellipse at center,rgba(255,255,255,.92),rgba(103,232,249,.38) 34%,transparent 72%);filter:blur(6px) drop-shadow(0 0 22px rgba(103,232,249,.88));z-index:4}.body-live-glow.is-active{opacity:1}.body-live-glow.head{background:radial-gradient(ellipse at center,rgba(255,255,255,.92),rgba(167,139,250,.46) 36%,transparent 72%);filter:blur(6px) drop-shadow(0 0 22px rgba(167,139,250,.9))}.body-live-glow.mix{background:radial-gradient(ellipse at center,rgba(255,255,255,.92),rgba(103,232,249,.48) 36%,transparent 72%);filter:blur(6px) drop-shadow(0 0 22px rgba(103,232,249,.86))}.body-live-glow.chest{background:radial-gradient(ellipse at center,rgba(255,255,255,.92),rgba(245,199,107,.46) 36%,transparent 72%);filter:blur(6px) drop-shadow(0 0 22px rgba(245,199,107,.86))}.register-labels{position:absolute;inset:0;z-index:5;pointer-events:none}.register-label{position:absolute;right:7%;transform:translateY(-50%);font-size:11px;font-weight:950;color:rgba(255,255,255,.58);text-transform:uppercase;letter-spacing:.05em;text-shadow:0 0 10px rgba(0,0,0,.6);white-space:nowrap}.label-head{top:23%}.label-mix{top:38%}.label-chest{top:55%}.register-label.active{color:#fff}.register-label.head{text-shadow:0 0 18px rgba(167,139,250,.95)}.register-label.mix{text-shadow:0 0 18px rgba(103,232,249,.95)}.register-label.chest{color:#f5c76b;text-shadow:0 0 18px rgba(245,199,107,.95)}.body-note-badge{position:absolute;left:14px;bottom:14px;border:1px solid rgba(255,255,255,.12);border-radius:18px;background:rgba(0,0,0,.44);padding:11px 13px;display:grid;gap:2px;z-index:6;backdrop-filter:blur(10px)}.body-note-badge small{color:rgba(255,255,255,.52)!important;font-size:10px;text-transform:uppercase;letter-spacing:.12em}.body-note-badge strong{color:#67e8f9;font-size:24px;line-height:1}@media(max-width:760px){.wireframe-body-wrap{position:absolute;inset:0;border-radius:0;background:transparent;padding:0;overflow:visible;place-items:center end}.body-aura{inset:5% -10% 7% 20%;filter:blur(18px);opacity:.7}.vocal-body-base{position:absolute;right:-20%;top:8dvh;width:112vw;height:76dvh;object-fit:contain;object-position:right top;opacity:.68;mix-blend-mode:screen;filter:drop-shadow(0 0 24px rgba(236,254,255,.18));z-index:2}.register-label{right:6%;font-size:11px;color:rgba(255,255,255,.5);letter-spacing:.04em}.label-head{top:25%}.label-mix{top:38%}.label-chest{top:51%}.body-note-badge{left:45%;bottom:18dvh;padding:9px 12px;border-radius:16px;background:rgba(0,0,0,.5);z-index:8}.body-note-badge strong{font-size:22px}.body-glow-zone.head{top:18%;width:22%;height:12%}.body-glow-zone.mix{top:29%;width:28%;height:19%}.body-glow-zone.chest{top:43%;width:34%;height:17%}.body-live-glow{z-index:4}}`;
