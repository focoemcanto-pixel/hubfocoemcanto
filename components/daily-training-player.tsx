    ...
    return (
      <section className="daily-training-screen">
        ...
        <header className="daily-training-head">
          ...
          <strong>TREINO GUIADO</strong>
          <span>DIA {step.day}</span>
        </header>
        <div className="daily-training-count">EXERCÍCIO {step.exerciseNumber} DE {total}</div>
        <div className="daily-training-player-slot">
    ...
    <section className="daily-immersive" style={style}>
      ...
      {stage === 'intro' ? (
        <div className="daily-intro-panel">
          ...
          <div className="daily-objective"><strong>O que vamos desenvolver</strong><ul><li>Soltar a voz sem fazer força.</li><li>Preparar a musculatura antes de cantar.</li><li>Perceber conforto antes de volume.</li></ul></div>
      ...
      {stage === 'setup' ? (
        <div className="daily-screen-panel setup-panel">
          <p className="daily-kicker">Treino personalizado</p><h1>Seu treino de hoje</h1>
          <div className="paper-card"><span>Este exercício foi preparado para sua região vocal.</span><strong>Tenor</strong><p>E3 → G5</p><small>Hoje vamos trabalhar em uma região confortável para começar sem tensão.</small></div>
          <div className="setup-details"><div><strong>Som usado</strong><span>Som relaxado</span></div><div><strong>Referência</strong><span>Piano + metrônomo</span></div><div><strong>Meta</strong><span>Conforto antes de volume</span></div></div>
