...
export const COURSE_ACCESS = [
  { key: 'grupo-vip', label: 'Grupo VIP', shortLabel: 'VIP', aliases: ['grupo-vip', 'grupo vip', 'grupo membros vip', 'grupo membros vip fh', 'membros vip', 'membros vip fh', 'vip fh', 'grupo vip foco em harmonia'] },
  { key: 'foco-em-harmonia', label: 'Foco em Harmonia', shortLabel: 'Harmonia', aliases: ['foco-em-harmonia', 'foco em harmonia', 'foco harmonia'] },
  { key: 'foco-em-canto', label: 'Foco em Canto', shortLabel: 'Canto', aliases: ['foco-em-canto', 'foco em canto pro', 'foco em canto', 'upgrade foco em canto'] },
