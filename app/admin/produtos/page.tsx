  ...
  return (
    <main className="admin-page-clean admin-products-compact">
      ...
      <section className="central-access-panel">
        <div className="central-access-head"><div><span className="admin-clean-eyebrow">Controle granular</span><h2>Central de Atividades</h2><p>Controle a liberação externa e interna da Central. Cada item fica como Aberto ou exclusivo para assinantes do Grupo VIP.</p></div><a className="admin-clean-button secondary" href="/aluno/central">Prévia da Central</a></div>
