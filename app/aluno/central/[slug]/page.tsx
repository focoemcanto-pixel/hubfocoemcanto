...
function LockedExercise({ level }: { level: string }) {
  return <AppShell hideNav><main className="training-locked-page"><style dangerouslySetInnerHTML={{ __html: lockedCss }} /><section className="training-locked-card"><span>🔒</span><h1>Exercício bloqueado</h1><p>Este exercício está marcado como {accessLabel(level as any)} no painel administrativo.</p><a href="/aluno/central">Voltar para Central</a></section></main></AppShell>;
}
