...
.premium-student-home{max-width:1040px;padding-top:8px}.bottom-nav{grid-template-columns:repeat(4,1fr);width:min(520px,calc(100% - 24px))}.premium-hero{position:relative;min-height:330px;overflow:hidden;border:1px solid rgba(255,255,255,.16);border-radius:32px;background:radial-gradient(circle at 72% 32%,rgba(245,199,107,.2),transparent 35%),linear-gradient(90deg,rgba(0,0,0,.9) 0%,rgba(0,0,0,.78) 42%,rgba(28,20,13,.52) 100%);box-shadow:0 34px 110px rgba(0,0,0,.48);padding:42px 44px;display:grid;grid-template-columns:minmax(0,1fr) 420px;align-items:center}.premium-hero:before{content:'';position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,0,0,.72),rgba(0,0,0,.2) 52%,rgba(0,0,0,.66)),radial-gradient(circle at 78% 70%,rgba(245,199,107,.22),transparent 30%);pointer-events:none}.premium-hero-copy{position:relative;z-index:2}.premium-hero h1{font-family:Georgia,'Times New Roman',serif;font-size:clamp(44px,6.2vw,66px);line-height:.92;margin:12px 0 14px;letter-spacing:-.045em}.premium-hero p:not(.eyebrow){max-width:430px;color:#b9b9c3;line-height:1.45}.premium-button{display:inline-flex;align-items:center;justify-content:center;gap:8px;padding:13px 22px;border-radius:18px;font-weight:900;border:1px solid rgba(255,255,255,.12);box-shadow:0 14px 34px rgba(0,0,0,.3)}.premium-button.gold{background:linear-gradient(180deg,#ffe39b,#e9b348);color:#160f07}.premium-button.dark{background:rgba(255,255,255,.08);color:#fff}.premium-hero-photo{position:absolute;right:0;top:0;bottom:0;width:48%;z-index:1;background:linear-gradient(90deg,rgba(0,0,0,0),rgba(0,0,0,.24)),radial-gradient(circle at 62% 44%,rgba(245,199,107,.34),transparent 28%)}.singer-silhouette{position:absolute;right:28px;bottom:0;width:340px;height:320px;border-radius:40% 40% 0 0;background:radial-gradient(circle at 45% 25%,rgba(255,226,176,.75),transparent 10%),radial-gradient(circle at 47% 36%,rgba(161,92,45,.8),transparent 18%),linear-gradient(160deg,rgba(245,199,107,.28),rgba(255,255,255,.04));filter:drop-shadow(0 28px 60px rgba(0,0,0,.6))}.singer-silhouette:before{content:'';position:absolute;left:92px;top:50px;width:74px;height:74px;border-radius:50%;background:linear-gradient(135deg,#9a5d38,#4d2b1d)}.singer-silhouette:after{content:'';position:absolute;right:24px;top:80px;width:64px;height:180px;border-radius:999px;background:linear-gradient(90deg,#bf884b,#2f251f);box-shadow:-34px 4px 0 -24px #e7bd74}.hero-icons{position:absolute;right:28px;top:26px;z-index:3;display:flex;gap:12px}.hero-icons span{display:grid;place-items:center;width:46px;height:46px;border-radius:50%;background:rgba(10,10,10,.62);border:1px solid rgba(255,255,255,.16);font-weight:900}.premium-stats{margin:-34px auto 18px;position:relative;z-index:5;width:88%;display:grid;grid-template-columns:repeat(4,1fr);border:1px solid rgba(255,255,255,.14);border-radius:24px;background:rgba(8,8,10,.74);backdrop-filter:blur(20px);box-shadow:0 28px 80px rgba(0,0,0,.38)}.premium-stats article{display:grid;grid-template-columns:auto auto 1fr;gap:10px;align-items:center;padding:20px 28px;border-right:1px solid rgba(255,255,255,.08)}.premium-stats article:last-child{border-right:0}.premium-stats span{display:grid;place-items:center;width:42px;height:42px;border-radius:50%;background:rgba(245,199,107,.12);box-shadow:0 0 26px rgba(245,199,107,.18)}.premium-stats strong{font-size:32px;line-height:1}.premium-stats p{margin:0;color:#aaa;font-size:13px}.premium-continue-panel{margin-top:16px;border:1px solid rgba(255,255,255,.12);border-radius:26px;background:rgba(255,255,255,.035);padding:18px;box-shadow:0 24px 80px rgba(0,0,0,.22)}.premium-section-heading{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:14px}.premium-section-heading h2{margin:0;font-size:25px}.premium-section-heading a{color:#f5c76b;font-weight:900}.premium-course-row{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.premium-course-card{position:relative;min-height:190px;border:1px solid rgba(255,255,255,.1);border-radius:18px;overflow:hidden;background:#111;transition:transform .2s,border-color .2s}.premium-course-card:hover{transform:translateY(-4px);border-color:rgba(245,199,107,.75)}.course-cover{height:145px;background-size:cover;background-position:center;display:flex;align-items:flex-end;padding:14px;position:relative}.course-cover strong{font-family:Georgia,'Times New Roman',serif;font-size:23px;line-height:.95;text-transform:uppercase;text-shadow:0 4px 22px #000}.course-badge{position:absolute;left:10px;top:10px;border:1px solid rgba(245,199,107,.65);border-radius:999px;background:rgba(245,199,107,.18);color:#f5c76b;text-transform:uppercase;font-size:10px;font-weight:900;padding:6px 8px}.course-meta{display:flex;justify-content:space-between;padding:9px 12px 6px;color:#c7c7d1;font-size:12px}.premium-course-card .progress{margin:0 12px 12px;height:6px}.premium-community-feed{margin-top:26px}.feed-video{width:100%;border-radius:20px;background:#050505;border:1px solid rgba(255,255,255,.12)}@media(max-width:900px){.premium-hero{grid-template-columns:1fr;min-height:380px;padding:30px 24px}.premium-hero-photo{opacity:.42;width:70%}.premium-stats{width:100%;grid-template-columns:repeat(2,1fr);margin-top:14px}.premium-stats article:nth-child(2){border-right:0}.premium-course-row{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:560px){.premium-hero h1{font-size:42px}.premium-stats{grid-template-columns:1fr}.premium-stats article{border-right:0;border-bottom:1px solid rgba(255,255,255,.08)}.premium-stats article:last-child{border-bottom:0}.premium-course-row{grid-template-columns:1fr}.premium-hero-photo{display:none}.premium-hero{min-height:auto}.hero-icons{display:none}}
`;
