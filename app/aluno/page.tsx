...
export default async function StudentPage() {
  ...
  const { data: follows } = profile?.id && authorIds.length ? await supabase.from('community_follows').select('following_id').eq('follower_id', profile.id).in('following_id', authorIds) : { data: [] };
