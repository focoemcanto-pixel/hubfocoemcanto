...
import { VocalRangeTest } from '@/components/vocal/vocal-range-test';
...
export default async function VocalProfilePage() {
  ...
  return (
    <AppShell>
      ...
      ) : <VocalRangeTest profileId={profileId} authUserId={user?.id || (profile as any)?.auth_user_id || null} initialProfile={vocalProfile} />}
    </AppShell>
  );
}
