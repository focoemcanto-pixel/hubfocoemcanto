...
import { VocalRangeTestV4 } from '@/components/vocal/vocal-range-test-v4';
...
export default async function VocalProfilePage() {
  ...
  return (
    <AppShell>
      ...
      ) : <VocalRangeTestV4 profileId={profileId} authUserId={user?.id || (profile as any)?.auth_user_id || null} initialProfile={vocalProfile} />}
    </AppShell>
  );
}
