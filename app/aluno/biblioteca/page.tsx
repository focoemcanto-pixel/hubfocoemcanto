    ...
    <AppShell>
      <main className="page school-library-page">
        ...
        <section className="school-library-hero">
          ...
          <p>Os acessos agora seguem os cursos reais do aluno. O VIP libera a sala de atividades e também reconhece o Foco em Harmonia.</p>
        </section>
        ...
        <section id="sala-vip" className={hasVip ? 'school-section course-room' : 'school-section course-room locked-room'}>
          <div className="course-room-header"><div><span className="eyebrow">Grupo VIP</span><h2>Sala de Atividades VIP</h2><p>Estes são os módulos atuais do Hub, liberados apenas para assinantes ativos do VIP.</p></div><span className="course-room-pill">{modules.length} módulos</span></div>
          {hasVip ? <div className="module-vertical-grid">{modules.map((module: any, index: number) => <ModuleCard module={module} index={index} key={module.id} />)}</div> : <div className="locked-callout"><strong>Acesso bloqueado.</strong><p>Você tem cursos na escola, mas a Sala de Atividades exige assinatura ativa do Grupo VIP.</p><a href={productLink(vipProduct, links.vip)}>Liberar acesso VIP →</a></div>}
        </section>
      </main>
    </AppShell>
  );
