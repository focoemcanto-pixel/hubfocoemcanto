...
const vipListCss = `.premium-module-group.locked-vip{position:relative;border:1px solid rgba(245,199,107,.26);border-radius:22px;background:rgba(245,199,107,.04);padding:10px}.premium-module-group.locked-vip .premium-lessons-list{opacity:.68;filter:saturate(.75)}.premium-module-group.locked-vip .premium-module-title strong{color:rgba(255,255,255,.58)}.vip-list-badge{margin-left:auto;border:1px solid rgba(245,199,107,.45);border-radius:999px;padding:5px 9px;color:#f5c76b;background:rgba(245,199,107,.1);font-size:11px;font-style:normal;font-weight:900}.premium-lesson-item.locked-vip-lesson{border:1px solid rgba(245,199,107,.14)}.premium-lesson-item.locked-vip-lesson .premium-lesson-copy small{color:#f5c76b}`;
