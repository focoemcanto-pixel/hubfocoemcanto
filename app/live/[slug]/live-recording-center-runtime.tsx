...
export default function LiveRecordingCenterRuntime() {
  ...
  return <>
    ...
    {open&&<div className="fl-recording-center-backdrop" onPointerDown={()=>!uploading&&setOpen(false)}><section className="fl-recording-center" onPointerDown={e=>e.stopPropagation()}>
      ...
      <footer>{mode==='daily'?'A disponibilidade depende do plano e da configuração da sua conta Daily.':'Ao encerrar a transmissão, a gravação é finalizada, enviada para a pasta padrão e publicada em /replay.'}</footer>
    </section></div>}
  </>;
}