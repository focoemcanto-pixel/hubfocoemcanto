...
describe('VoiceStudioRuntime', () => {
  it('owns AudioContext lazily and keeps it outside the session callback contract', async () => {
  ...
  it('owns object URLs, decoded audio and waveform caches', () => {
    ...
    expect(runtime.registerObjectURL('asset-a', blob)).toBe('blob:asset-a');
  ...
  it('provides a scheduler and playback clock without starting them automatically', () => {
